...
@Service
class BackToSettingMark(
    private val userService: UserService,
    private val applicationEventPublisher: ApplicationEventPublisher
) : CallbackHandler {
    override fun handle(callbackQuery: CallbackQuery) {
        applicationEventPublisher.publishEvent(SetStateEvent(callbackQuery.from, States.WAITING_FOR_MARK_INPUT))
    }

    override fun getCallbackCode() = Callbacks.BACK_TO_SETTING_MARK.code
